...
class __TwigTemplate_49e87b295db18b0f101f1145f2495f8b3d471eecc07375c6b92d9689dbf0d5d8 extends Twig_Template
{
  ...
  ";
    ...
    ";
        // line 92
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without(($context["content"] ?? null), "comment", "links", "field_tags"), "html", null, true));
        echo "
  </div>

  ";
        // line 95
        if ((twig_length_filter($this->env, $this->getAttribute(($context["content"] ?? null), "field_tags", array())) &&  !($context["is_front"] ?? null))) {
            // line 96
            echo "    ";
...
";
    ...
    {
        return new Twig_Source("", "themes/zurb_foundation/templates/node.html.twig", "/var/www/html/drupal-8.4.x-dev/themes/zurb_foundation/templates/node.html.twig");
    }
}
